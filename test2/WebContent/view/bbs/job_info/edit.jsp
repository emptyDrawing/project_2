	...
	$(function(){
		$('form').submit(function(e){
			...
			console.log(numCheck($('#hirenum')));
				...
				$.post("?mode=edit&idx=${dtoJobInfo.num}", queryString, function(data){
					if(data=="오류"){
...
<body>
	...
	<hr class="bar"/>
		...
		<span class="navigator deps">&nbsp;&rsaquo;&nbsp;</span>
		<span class="navigator final">취업정보 수정</span>
		...
		<div id="container">
				...
				<form method="post">
					<div class ="">		
						...
						<input class="input" type="text" name="title" id="title" value="${dtoJobInfo.title}"/>
					</div>	
					<div class ="">
						<label class="subject" for="company">업체명</label>
						<input class="input" type="text" name="company" id="company" value="${dtoJobInfo.company}"/>	
					</div>
					<div class ="">
						<label class="subject_short" for="hirenum">모집인원</label>
						<input class="input_short" type="text" name="hirenum" id="hirenum" value="${dtoJobInfo.hireNum}"/>	
						<label class="subject_short" for="company">고용형태</label>
						<input class="input_short" type="text" name="hiretype" id="hiretype" value="${dtoJobInfo.hireType}"/>	
					</div>
					<div class ="">
						<label class="subject_short" for="region">근무지</label>
						<input class="input_short" type="text" name="region" id="region" value="${dtoJobInfo.region}"/>	
						<label class="subject_short"for="duedate">마감일</label>
						<input class="input_short" type="date" name="duedate" id="duedate" value="${dtoJobInfo.dueDate}"/>	
					</div>
					<div class ="">
						<label class="subject_short" for="sal">급여</label>
						<input class="input_short" type="text" name="sal" id="sal" value="${dtoJobInfo.sal}"/>	
						<label class="subject_short" for="qualify">모집자격</label>
						<input class="input_short" type="text" name="qualify" id="qualify" value="${dtoJobInfo.qualify}"/>	
					</div>
					<div class ="">
						<label class="subject" for="email">접수처메일</label>
						<input class="input" type="text" name="email" id="email" value="${dtoJobInfo.email}"/>	
					</div>
					<div>
						<textarea class="textarea" name="contents" rows="" cols="">${dtoJobInfo.contents}</textarea>
					</div>	
