	...
	<nav id="nav">
		<ul id="menu">
			...
			<li id="mymenu" class="topmenu"><a href="#" class="topmenuLink">내 메뉴</a>
				<ul class="submenu">
					<li><a href="${rootPath }bbs/consult.bit?mode=list" class="submenuLink">상담게시판</a></li>
		...
		<div id="login">
		    <div class="temp1">
		        <span>
		            <img src="${rootPath}img/login/sales.png" class="identity"><a href="#" class="in">${web_name } 님(영업)</a>
		        </span>
		    </div>
		    <div class="temp2">
