	...
	<nav id="nav">
		<ul id="menu">
			...
			<li id="mymenu" class="topmenu"><a href="#" class="topmenuLink">내 메뉴</a>
				<ul class="submenu">
					<li><a href="${rootPath}mymenu.bit?pageid=score_con&mode=list" class="submenuLink">성적관리</a></li>
					<li><a href="${rootPath}mymenu.bit?pageid=attend_con&mode=check" class="submenuLink">출결관리</a></li>
		...
		<div id="login">
		    <div class="temp1">
		        <span>
		            <img src="${rootPath}img/login/teacher.png" class="identity"><a href="#" class="in">${web_name } 님(강사)</a>
		        </span>
		    </div>
		    <div class="temp2">
