	...
	<nav id="nav">
		<ul id="menu">
			...
			<li id="mymenu" class="topmenu"><a href="#" class="topmenuLink">내 메뉴</a>
				<ul class="submenu">
					<li><a href="${rootPath }mymenu.bit?pageid=attend_con&mode=detail" class="submenuLink">출석확인</a></li>
					<li><a href="${rootPath }mymenu.bit?pageid=score_con&mode=detail" class="submenuLink">성적확인</a></li>
					<li><a href="${rootPath }bbs/lec_notice.bit?mode=list" class="submenuLink longlink">강의 공지사항</a></li>
				</ul>
			</li>
		</ul>
		<!--로그인 시작-->
		<div id="login">
		    <div class="temp1">
		        <span>
		            <img src="${rootPath}img/login/student.png" class="identity"><a href="#" class="in">${web_name } 님(학생)</a>
		        </span>
		    </div>
		    <div class="temp2">
